/**
  ...
  * @attention      v1.1   	jgb		20151117  重构 		
  			      v1.2        		20170306  修改框架，直接返回键值
  			      v1.3              20170429  再次重构，避免更多用户修改介入       
  ******************************************************************************
  */
/*
; 关于按键功能说明
...
*/
/*  使用说明
 *  根据mkey_decetor_task 周期调用时间定义宏
 *  定义要使用的键值  短按 长按  抬键
 *  调用mkey_create 创建按键功能
 *  调mkey_getvalue 获得键值
 *
 */
