...
#define ADC_FULL_SCAL	4095	// 精度12
...
#define HAL_ADC_ACTIVE_Clock_EN() do{RCC_APB2PeriphClockCmd(RCC_APB2Periph_ADC1, ENABLE);}while(0)
#define HAL_ADC_GPIO_PeriphClock_EN() do{RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOA, ENABLE);\
                                        RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOB, ENABLE);}while(0)
#define ADC_DMA_ACTIVE_Clock_EN() 	do{RCC_AHBPeriphClockCmd(RCC_AHBPeriph_DMA1, ENABLE);}while(0)
